...
const COUNTRY_CONFIG = {
  ...
  lang: {
    ...
    paymentDesc: 'Pagherai in contanti al corriere',
    shipping: 'Spedizione Rapida',
    shippingDesc: 'Consegna in 24/48 ore lavorative',
    returns: '30 Giorni per Restituire',
    returnsDesc: 'Rimborso completo se non sei soddisfatto',
    warranty: 'Garanzia 2 Anni',
    warrantyDesc: 'Su tutti i prodotti',
    callInfo: 'Ti chiameremo a breve',
    callDesc: 'Un nostro operatore ti contatterà per confermare i dettagli della spedizione.',
    support: 'Hai bisogno di assistenza?',
...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      // Google Ads Conversion ID and Label for Italy
      const GOOGLE_ADS_CONVERSION_ID = 'AW-17806346250';
      const GOOGLE_ADS_CONVERSION_LABEL = 'AW17806346250_IT';
