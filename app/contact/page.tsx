...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Get in touch with Acartify for wholesale tech enquiries and quotes.",
};
            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"></textarea>
                </div>
                <button type="submit" className="w-full py-2.5 bg-teal-600 text-white font-medium rounded-lg hover:bg-teal-500">
                  Send Message
                </button>
              </form>
            </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { t: "Email", v: "info@acartify.com", d: "Response within 24 hours" },
                    { t: "Address", v: "22 Rue de Commerce, Paris 75015", d: "France" },
                    { t: "Hours", v: "Monday - Friday", d: "9:00 AM - 6:00 PM CET" },
                  ].map((c, i) => (
                    <div key={i} className="p-4 bg-gray-50 rounded-lg">
                      <h3 className="font-semibold text-gray-900">{c.t}</h3>
                      <p className="text-teal-600">{c.v}</p>
