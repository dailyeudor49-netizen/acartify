...
const LandingPage = () => {
  ...
  return (
    <div className="pb-24 md:pb-0 bg-white min-h-screen font-sans text-gray-900 overflow-x-hidden">
      ...
      <img
        src="https://offers.uncappednetwork.com/forms/api/ck/?o=3160&uid=0191b25c-22d2-7f55-9d9b-79b67cebbff3&lp=3194"
      ...
      <div className="bg-yellow-300 py-2 md:py-3 text-center px-4 border-b-2 border-yellow-400">
        <p className="text-red-900 font-black text-xs md:text-base uppercase tracking-wide flex items-center justify-center gap-2 animate-pulse-fast">
           ⚠️ STOP! Wyprzedaż Całkowita - Ostatnie 14 Sztuk
        </p>
      </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="text-center mb-6 md:mb-10 max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-black leading-[1.0] mb-4 uppercase tracking-tight">
              TNIE GAŁĘZIE DO 8CM <br className="hidden md:block" />
              <span className="bg-yellow-400 px-2 text-black transform -skew-x-6 inline-block mt-2 md:mt-0">JAK MASŁO.</span>
            </h1>
            <h2 className="text-lg md:text-2xl font-bold text-gray-600 leading-tight max-w-2xl mx-auto mb-6">
              Koniec z bólem pleców. Przytnij cały ogród <span className="text-red-600 font-black underline decoration-2 underline-offset-4">bez wysiłku</span> i w połowie czasu.
            </h2>
          </div>
            ...
            <div className="w-full md:w-1/2 mt-2 md:mt-0 relative mb-8 md:mb-0">
               ...
               <div className="relative mx-auto max-w-[500px] md:max-w-full md:sticky md:top-24">
                   ...
                   <div className="bg-red-600 text-white rounded-b-2xl shadow-lg px-4 py-2 flex items-center justify-center gap-3 border-4 border-t-0 border-red-600">
                      ...
                      <span className="text-sm md:text-base font-black uppercase text-white">ZESTAW AKCESORIÓW</span>
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              ...
              <div className="text-center relative bg-white p-1 rounded-2xl border-4 border-red-600 shadow-2xl">
                <div className="bg-red-600 text-white py-2 font-black uppercase tracking-widest text-sm md:text-base">
                  🔥 Oferta Błyskawiczna: {DISCOUNT_PERCENT} TERAZ
                </div>
                ...
                <div className="p-6">
                    <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-4 mb-6">
                       <div className="flex flex-col items-center md:items-start">
                          ...
                          <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider">Oszczędzasz 279 zł</span>
                       </div>
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-6">
                        <div className="bg-gray-100 border border-gray-300 rounded-lg p-2 flex flex-col items-center justify-center">
                            ...
                            <span className="text-[10px] md:text-xs font-black uppercase text-gray-800 leading-tight">Gwarancja<br/>2 Lata</span>
                        </div>
                        <div className="bg-gray-100 border border-gray-300 rounded-lg p-2 flex flex-col items-center justify-center">
                            <RefreshCw className="w-6 h-6 text-green-600 mb-1" />
                            <span className="text-[10px] md:text-xs font-black uppercase text-gray-800 leading-tight">Satysfakcja lub<br/>Zwrot Pieniędzy</span>
                        </div>
                    </div>
                    ...
                    <div className="bg-green-50 border-2 border-green-500 border-dashed rounded-lg p-3 mb-6 flex items-center justify-center gap-3 animate-pulse">
                        ...
                        <div className="text-left">
                            <span className="block text-xs font-bold text-green-800 uppercase">Zero Ryzyka</span>
                            <span className="block text-lg md:text-xl font-black text-green-700 uppercase leading-none">PŁACISZ PRZY ODBIORZE</span>
                        </div>
                    </div>
                    ...
                    >
                      <span className="flex items-center gap-2 drop-shadow-md">CHCĘ ZAMÓWIĆ <ArrowDown className="w-6 h-6 md:w-8 md:h-8 animate-bounce" /></span>
                    </button>

                    <p className="mt-3 text-xs text-gray-400 font-bold uppercase tracking-wide">
                        *Szybka Wysyłka 24/48h
                    </p>
                </div>
              </div>
      ...
      <section className="bg-gray-50 py-6 border-y border-gray-200">
         <div className="container mx-auto px-4 text-center max-w-6xl">
            <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">Widziane w</p>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto px-4 max-w-5xl">
           <h2 className="text-3xl md:text-5xl font-black text-center uppercase mb-10 leading-tight">
             KONIEC Z <span className="bg-red-600 text-white px-2">MĘCZARNIĄ</span> W OGRODZIE
           </h2>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 md:p-8 border-2 border-gray-100 relative opacity-75 hover:opacity-100 transition-opacity">
                 ...
                 <div className="flex items-center gap-4 mb-4">
                    ...
                    <h3 className="font-black text-xl uppercase text-red-900">Ból i Zmęczenie</h3>
                 </div>
              ...
              <div className="bg-green-50 rounded-2xl p-6 md:p-8 border-4 border-green-500 relative shadow-xl transform md:scale-105">
                 <div className="absolute -top-4 left-6 bg-green-600 text-white font-black px-4 py-1 uppercase text-sm rounded shadow-lg flex items-center gap-2">
                    <Star className="w-3 h-3 fill-white" /> Wybór Profesjonalistów
                 </div>
                 <div className="flex items-center gap-4 mb-4">
                    <CheckCircle2 className="w-10 h-10 text-green-600" />
                    <h3 className="font-black text-xl uppercase text-green-900">Zero Wysiłku</h3>
                 </div>
                 <ul className="space-y-3">
      ...
      <section className="py-12 md:py-20 bg-gray-900 text-white">
         <div className="container mx-auto px-4 max-w-6xl text-center">
            <h2 className="text-3xl md:text-5xl font-black uppercase leading-none mb-3">
               POTĘŻNA <span className="text-green-500">MOC</span>
            </h2>
            <p className="text-gray-400 mb-12 max-w-2xl mx-auto font-medium">
                Technologia LithiumPro™ jest zaprojektowana na całe życie. Każdy element jest wzmocniony do intensywnego użytkowania.
            </p>
         ...
         <div className="container mx-auto px-4 max-w-6xl relative z-10">
            <div className="text-center mb-12">
               <div className="inline-block bg-green-100 text-green-800 font-bold text-xs uppercase px-3 py-1 rounded-full mb-4 border border-green-200">
                  TECHNOLOGIA PRECYZYJNA
               </div>
               <h2 className="text-3xl md:text-5xl font-black uppercase leading-[1.1] mb-6 text-gray-900">
                  TO NIE TYLKO SEKATOR. <br/>
                  TO PRZEDŁUŻENIE <span className="text-green-600 underline decoration-4 decoration-green-200 underline-offset-4">TWOJEJ RĘKI.</span>
               </h2>
               <p className="text-lg md:text-xl font-medium text-gray-600 max-w-3xl mx-auto leading-relaxed">
                  Zapomnij o zmęczeniu i bólu na koniec dnia. LithiumPro™ jest zaprojektowany, aby pracować ciężko za Ciebie.
               </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               ...
               <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:border-green-400 transition-all group relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-black uppercase mb-3 text-gray-900">MOC BRUSHLESS</h3>
                  <p className="text-gray-600 leading-relaxed font-medium">
                     Cyfrowy silnik 600W generuje potężny moment obrotowy. Żadna gałąź nie ma szans: <strong className="text-gray-900">miażdży suche i zielone drewno do 8cm</strong> jak masło, nigdy nie zwalniając.
                  </p>
               </div>
               ...
               <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:border-green-400 transition-all group relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-black uppercase mb-3 text-gray-900">CAŁKOWITE BEZPIECZEŃSTWO</h3>
                  <p className="text-gray-600 leading-relaxed font-medium">
                     Dzięki inteligentnym czujnikom pracujesz w pełnym spokoju. Aktywny system ochrony <strong className="text-gray-900">zapobiega przypadkowym przecięciom</strong>, czyniąc go najbezpieczniejszym narzędziem, jakiego kiedykolwiek używałeś.
                  </p>
               </div>
               ...
               <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100 hover:border-green-400 transition-all group relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-black uppercase mb-3 text-gray-900">CHIRURGICZNE CIĘCIE</h3>
                  <p className="text-gray-600 leading-relaxed font-medium">
                     Ostrza SK5 ze stali węglowej nigdy nie tępią. Cięcie jest tak czyste i szybkie (0.3 sekundy), że <strong className="text-gray-900">roślina goi się natychmiast</strong>, zapobiegając chorobom i szkodnikom.
                  </p>
               </div>
            </div>
            ...
            <div className="mt-16 text-center">
               <div className="inline-block bg-white px-8 py-6 rounded-2xl shadow-lg border border-gray-100 max-w-3xl relative">
                  ...
                  <p className="text-xl md:text-2xl font-black uppercase text-gray-800 leading-tight italic relative z-10">
                     "Wyobraź sobie zamianę 4 godzin piekła na słońcu na <span className="text-green-600 underline decoration-yellow-400 decoration-4">40 minut czystej przyjemności</span>."
                  </p>
               </div>
            </div>
         </div>
         ...
         <div className="container mx-auto px-4 max-w-4xl">
             <div className="text-center mb-8">
                 <h2 className="text-3xl md:text-4xl font-black uppercase text-gray-900 leading-none">
                   DLACZEGO WYBRAĆ <span className="text-red-600">LITHIUM PRO</span>?
                 </h2>
             </div>
             <ComparisonTable />
         </div>
         ...
         <div className="container mx-auto px-4 max-w-5xl relative z-10">
            <div className="text-center mb-10">
               ...
               <div className="inline-flex items-center gap-2 bg-black text-yellow-400 px-6 py-2 rounded-full font-bold uppercase text-sm shadow-lg animate-bounce">
                  ...
                  Wartość Akcesoriów: 400+ zł (GRATIS)
               </div>
            </div>
            ...
            <div className="bg-white border-4 border-green-500 rounded-3xl overflow-hidden shadow-2xl">
               <div className="bg-green-500 text-white text-center py-3 font-black text-lg uppercase tracking-wider">
                  KOMPLETNY ZESTAW PREMIUM
               </div>

               <div className="flex flex-col md:flex-row">
                    {/* Image Column */}
                    <div className="w-full md:w-1/2 bg-gray-100 relative group">
                        <img src={KIT_IMAGE_URL} alt="Kompletny Zestaw" className="w-full h-full object-cover min-h-[300px] md:min-h-[500px]" />
                    ...
                    <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center">
                      ...
                      <div className="bg-gray-100 rounded-xl p-4 text-center border border-gray-200">
                         <p className="text-xs font-bold text-gray-500 uppercase mb-1">Płacisz tylko przy odbiorze</p>
      ...
      <section className="py-16 bg-white">
         <div className="container mx-auto px-4 max-w-6xl">
            <div className="text-center mb-10">
               <h2 className="text-3xl md:text-4xl font-black uppercase text-gray-900">Kto Już Używa</h2>
               ...
               <p className="text-sm text-gray-500 font-bold uppercase tracking-widest mt-2">Ponad 2000 Zadowolonych Klientów</p>
            </div>
                  ...
                  <div key={review.id} className="bg-gray-50 p-6 rounded-2xl border border-gray-200 shadow-sm relative flex flex-col">
                     ...
                     {review.reviewImage && (
                        <div className="mb-4 rounded-lg overflow-hidden border border-gray-200 relative group">
                            <img src={review.reviewImage} alt="Zdjęcie od klienta" className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500" />
      ...
      <section className="py-0 bg-white">
        <div className="bg-red-600 py-10 px-4 text-center clip-path-slant">
             <div className="bg-yellow-400 text-black text-xs font-black px-4 py-1 inline-block uppercase tracking-widest mb-4 rounded transform -rotate-2 shadow-lg">
               RABAT {DISCOUNT_PERCENT} AKTYWNY TERAZ
             </div>
             <h2 className="text-3xl md:text-5xl font-black text-white uppercase leading-none mb-3">
               ZAMÓW TERAZ
             </h2>
             <p className="text-white/90 text-lg font-bold uppercase tracking-widest">Płatność przy Odbiorze</p>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-xl -mt-8">
           ...
           <div className="bg-gray-50 rounded-2xl p-4 md:p-6 mb-6 border border-gray-200">
              <h3 className="text-lg md:text-xl font-black text-gray-900 uppercase text-center mb-4">Jak Zamówić w 4 Krokach</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                 <div className="text-center">
                    ...
                    <p className="text-xs font-bold text-gray-800">Wypełnij formularz</p>
                    <p className="text-[10px] text-gray-500">Wpisz swoje dane poniżej</p>
                 </div>
                 <div className="text-center">
                    ...
                    <p className="text-xs font-bold text-gray-800">Oddzwonimy</p>
                    <p className="text-[10px] text-gray-500">Potwierdzimy dane</p>
                 </div>
                 <div className="text-center">
                    ...
                    <p className="text-xs font-bold text-gray-800">Szybka Wysyłka</p>
                    <p className="text-[10px] text-gray-500">Dostawa w 24/48 godzin</p>
                 </div>
                 <div className="text-center">
                    ...
                    <p className="text-xs font-bold text-gray-800">Płatność przy odbiorze</p>
                    <p className="text-[10px] text-gray-500">Płacisz gotówką kurierowi</p>
                 </div>
              </div>
           </div>
           ...
           <div className="text-center py-10 text-gray-400 text-xs">
              <p className="mb-2 flex items-center justify-center gap-2 font-bold"><Shield className="w-4 h-4"/> GWARANCJA 2 LATA W ZESTAWIE</p>
           </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-gray-50 border-t border-gray-200">
         <div className="container mx-auto px-4 max-w-2xl">
            <h3 className="text-2xl font-black text-gray-900 uppercase text-center mb-8">Często Zadawane Pytania</h3>
            <FAQ items={FAQS} />
         </div>
      </section>
