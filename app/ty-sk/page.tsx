...
const COUNTRY_CONFIG = {
  ...
  lang: {
    ...
    subtitle: 'Vaša objednávka bola úspešne prijatá.',
    orderCode: 'Číslo objednávky',
    payment: 'Platba na dobierku',
    paymentDesc: 'Zaplatíte kuriérovi v hotovosti',
    shipping: 'Rýchle doručenie',
    shippingDesc: 'Doručenie do 24/48 hodín',
    returns: '30 dní na vrátenie',
    returnsDesc: 'Plná náhrada, ak nie ste spokojní',
    warranty: '2 roky záruka',
    warrantyDesc: 'Na všetky produkty',
    callInfo: 'Čoskoro vám zavoláme',
    callDesc: 'Náš operátor vás bude kontaktovať pre potvrdenie údajov o doručení.',
    support: 'Potrebujete pomoc?',
...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      // Google Ads Conversion ID and Label for Slovakia
      const GOOGLE_ADS_CONVERSION_ID = 'AW-17806346250';
      const GOOGLE_ADS_CONVERSION_LABEL = 'u0wACMyLwdUbEIqQ3apC';
