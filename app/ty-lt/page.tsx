...
const COUNTRY_CONFIG = {
  ...
  lang: {
    ...
    subtitle: 'Jūsų užsakymas sėkmingai priimtas.',
    orderCode: 'Užsakymo numeris',
    payment: 'Mokėjimas pristatymo metu',
    paymentDesc: 'Mokėsite kurjeriui grynaisiais',
    shipping: 'Greitas pristatymas',
    shippingDesc: 'Pristatymas per 24/48 valandas',
    returns: '30 dienų grąžinimui',
    returnsDesc: 'Pilnas pinigų grąžinimas, jei nesate patenkinti',
    warranty: '2 metų garantija',
    warrantyDesc: 'Visiems produktams',
    callInfo: 'Netrukus paskambinsime',
    callDesc: 'Mūsų operatorius susisieks su jumis dėl pristatymo detalių patvirtinimo.',
