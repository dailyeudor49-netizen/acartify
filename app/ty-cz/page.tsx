...
const COUNTRY_CONFIG = {
  ...
  lang: {
    ...
    subtitle: 'Vaše objednávka byla úspěšně přijata.',
    orderCode: 'Číslo objednávky',
    payment: 'Platba na dobírku',
    paymentDesc: 'Zaplatíte kurýrovi v hotovosti',
    shipping: 'Rychlé doručení',
    shippingDesc: 'Doručení do 24/48 hodin',
    returns: '30 dní na vrácení',
    returnsDesc: 'Plná náhrada, pokud nejste spokojeni',
    warranty: '2 roky záruka',
    warrantyDesc: 'Na všechny produkty',
    callInfo: 'Brzy vám zavoláme',
    callDesc: 'Náš operátor vás bude kontaktovat pro potvrzení údajů o doručení.',
...
export default function ThankYouPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && !alreadyTracked) {
      ...
      // Google Ads Conversion ID and Label for Czech Republic
      const GOOGLE_ADS_CONVERSION_ID = 'AW-17806346250';
      const GOOGLE_ADS_CONVERSION_LABEL = '5gc8CK2EwdUbEIqQ3apC';
      ...
      <div className="ty-box" style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
            <div style={{ width: '32px', height: '32px', background: '#16a34a', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '1rem' }}>Kč</div>
            <div>
